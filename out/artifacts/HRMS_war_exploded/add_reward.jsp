...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
            <!-- / .main-navbar -->
            <form method="post" onsubmit="getValue()" action="save_reward.jsp">
                                    ...
                                    <form class="add-new-post" >
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="name" placeholder="姓名" name="name"> </div>
                                            <div class="form-group col-md-6">
                                                <label for="department">部门</label>
                                                <input type="text" class="form-control" id="department" placeholder="部门" name="department"> </div>
                                        </div>
